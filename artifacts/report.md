...
| LVS report DB | disabled | `/home/yongfu/proj/iopad-automation/artifacts/pad_ring.lvsdb` |
| DRC report DB | disabled | `/home/yongfu/proj/iopad-automation/artifacts/pad_ring_drc.lyrdb` |

### Notes

- DRC execution is controlled by `--drc/--no-drc` or `signoff.drc.enabled` in `io.yaml`.
- LVS row reflects the KLayout extraction step used for netlist generation.
